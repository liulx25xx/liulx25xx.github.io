    ...
    >
      <div className="flex flex-col gap-2 justify-center items-center w-full sm:w-[85%] m-auto">
        ...
        <p className="text-base sm:text-lg">
          I'm currently open to new opportunities, whether it's an internship, a full-time position, or a collaborative project. Feel free to reach out if you are
          interested in having me on your team, working together, or just want to say hello. Please click the button below
          or send an email to{" "}
          <Link
            href={"mailto:liulx25@mails.tsinghua.edu.cn"}
            className=" text-secondary-color-3 font-medium"
          >
            liulx25@mails.tsinghua.edu.cn
          </Link>
          .
        </p>
